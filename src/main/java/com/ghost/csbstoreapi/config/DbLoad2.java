...
//
//        Address e1 = new Address(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli2, city1);
//        Address e2 = new Address(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli2, city2);
//
//        cli2.getAddress().addAll(Arrays.asList(e1, e2));
//
...
//
//        BuyOrder ped1 = new BuyOrder(null, sdf.parse("30/09/2017 10:32"), cli2, e1);
//        BuyOrder ped2 = new BuyOrder(null, sdf.parse("10/10/2017 19:35"), cli2, e2);
//
...
//
//        cli2.getBuyOrder().addAll(Arrays.asList(ped1, ped2));
//
